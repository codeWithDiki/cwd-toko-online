...
class TransactionRefunded extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->greeting("Pesanan Sudah Direfund.")
            ->line('Transaksi dengan nomor transaksi: ' . $this->transaction->trx_id . ' sudah direfund oleh penjual.')
