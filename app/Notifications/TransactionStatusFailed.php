...
class TransactionStatusFailed extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->greeting("Pesanan Gagal!")
            ->line('Transaksi dengan nomor transaksi: ' . $this->transaction->trx_id . ' gagal diproses oleh penjual.')
