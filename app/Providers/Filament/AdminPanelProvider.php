...
use App\Filament\Widgets\LatestTransactionWidget;
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->plugins([
                ...
                new ProductModuleFilament,
                new TransactionModuleFilament,
                new PaymentModuleFilament
            ])
            ->authMiddleware([
                Authenticate::class,
            ]);
